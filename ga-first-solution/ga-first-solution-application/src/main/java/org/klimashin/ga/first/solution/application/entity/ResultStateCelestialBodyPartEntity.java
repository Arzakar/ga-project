...
@Setter
@Entity
@Table(name = "result_state_celestial_body_part")
@FieldDefaults(level = AccessLevel.PRIVATE)
public class ResultStateCelestialBodyPartEntity {
    ...
    @JoinColumn(name = "result_state_id", nullable = false)
    ResultStateEntity resultStateEntity;
